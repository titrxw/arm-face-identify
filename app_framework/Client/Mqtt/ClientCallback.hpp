...
#ifndef ARM_IOT_CLIENTCALLBACK_HPP
#define ARM_IOT_CLIENTCALLBACK_HPP
...
namespace IOT {
    namespace CLIENT {
        namespace MQTT {
            ...
            public:
                ClientCallback(async_client *client, connect_options connectOptions, int maxConnectRetry = 5) : client(
                        client), connectOptions(std::move(connectOptions)), maxConnectRetry(maxConnectRetry) {}
...
#endif //ARM_IOT_CLIENTCALLBACK_HPP
