...
#ifndef ARM_IOT_FILESYSTEM_HPP
#define ARM_IOT_FILESYSTEM_HPP
...
namespace IOT {
    namespace UTIL {
        ...
        public:
            ...
            void static
            write(const string &filePath, const string &content, ios_base::openmode mode = ios::trunc | ios::out) {
